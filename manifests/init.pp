...
class winlogbeat (
  ...
  Variant[Boolean, Enum['stopped', 'running']] $service_ensure,
  ...
  String[4,4]  $config_dir_mode,
  String[4,4]  $config_file_mode,
  ...
  Optional[Variant[Stdlib::HTTPUrl, Stdlib::HTTPSUrl]] $download_url,
